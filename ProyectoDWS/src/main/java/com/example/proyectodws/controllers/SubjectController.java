...
public class SubjectController {
    ...
    public String showCoursesForSubject(Model model, @PathVariable long id) {
        SubjectDTOWithCourses subject = subjectService.getSubjectByIdWithCourses(id);
    ...
    public String deleteSubject(Model model, @PathVariable long id) throws IOException {
        ...
        mediaService.deleteImage(SUBJECTS_FOLDER, id); // Delete the image associated with the language
